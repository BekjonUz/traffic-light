...
useEffect(() => {
  ...
  return (
    <div className="w-[1200px] mx-auto mt-[1rem]">
      ...
      {
        time>3?<div className="bg-gray-500 w-[100px] h-[100px] flex justify-center items-center rounded-[50%]"></div>:<div className="bg-yellow-300 w-[100px] h-[100px] flex justify-center items-center text-white rounded-[50%]"></div>
      }
      {
        count%2!==0?<div className="bg-green-400 w-[100px] h-[100px] flex justify-center items-center text-white rounded-[50%]"></div>:<div className="bg-gray-500 w-[100px] h-[100px] flex justify-center items-center text-white rounded-[50%]"></div>
      }
      </div>
      <div className="w-[25rem] h-[5rem] bg-[#00000085]">
      </div>
